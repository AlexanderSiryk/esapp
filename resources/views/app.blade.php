...
<head>
    ...
    <link href="{{asset('../frontend/static/css/main.chunk.css')}}" type="text/css" rel="stylesheet">
...
<script src="{{asset('../frontend/static/js/2.chunk.js')}}"></script>
<script src="{{asset('../frontend/static/js/main.chunk.js')}}"></script>
</body>
</html>
