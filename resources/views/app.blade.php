...
<head>
    ...
    <link href="{{asset('../frontend/build/static/css/main.chunk.css')}}" type="text/css" rel="stylesheet">
...
<script src="{{asset('../frontend/build/static/js/2.chunk.js')}}"></script>
<script src="{{asset('../frontend/build/static/js/main.chunk.js')}}"></script>
</body>
</html>
